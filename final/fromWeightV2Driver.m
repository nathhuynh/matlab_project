...
[element_name, element_symbol, element_number, element_weight] = fromWeightV2(elementWeight);
fprintf("input: %0.3f | expected: %s | result: %s - %s - %d - %0.3f\n", ...
...
[element_name, element_symbol, element_number, element_weight] = fromWeightV2(elementWeight);
fprintf("input: %0.2f | expected: %s | result: %s - %s - %d - %0.2f\n", ...
    elementWeight, expected, element_name, element_symbol, element_number, element_weight);
...
% input: 1 (incorrect weight)
elementWeight = 1;
expected = "Element could not be found with weight: 1";
[element_name, element_symbol, element_number, element_weight] = fromWeightV2(elementWeight);
fprintf("input: %d | expected: %s | result: %s - %s - %d - %d\n", ...
    elementWeight, expected, element_name, element_symbol, element_number, element_weight);
